...
const Navbar = () => {
  ...
  return (
    <motion.nav
      ...
      className={`transition-transform duration-300 fixed top-5 w-[90%] max-w-7xl left-1/2 transform -translate-x-1/2 z-30  px-4 py-3 md:px-6 md:py-4 rounded-full bg-white border-b border-gray-100 flex items-center justify-between ${
